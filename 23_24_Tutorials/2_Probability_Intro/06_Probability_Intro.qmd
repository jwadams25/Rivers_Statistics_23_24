...
This tutorial introduces you to some core functions in R that allow you to explore probability.

::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #FF585D; border-radius: 5px;"}
The goals of this lab are outlined in red like this.
:::

::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
Any question you should answer is outlined in blue like this.
:::
...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
**What does a streak length of 1 mean? In other words, how many hits and misses are in a streak of 1? What about a streak length of 0?**
:::
...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
**Describe the distribution of Kobe's streak lengths from the 2009 NBA finals. What was his typical streak length? How long was his longest streak of baskets? Make sure to reference the plot you just created in your answer.**
:::
...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
**Change `PROB_HEADS` and `PROB_TAILS`** **to allow the computer to simulate the unfair coin mentioned in the description above. Tip: You will need to enter a value between 0 and 1.**
:::
...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
**In your simulation of flipping the unfair coin 100 times, how many flips came up heads? Include the code for sampling the unfair coin in your response. Since the Quarto file will run the code, and generate a new sample each time you *Render* it, you should also "set a seed" before you sample. Read more about setting a seed below.**
:::

```{r your-code-for-this-question}

```

::: {#boxedtext}
**A note on setting a seed:** Setting a seed will cause R to select the same sample each time you render your document.
This will make sure your results don't change each time you render, and it will also ensure reproducibility of your work (by setting the same seed it will be possible to reproduce your results).
...
```{r your-simulation}
shot_outcomes <- c("H", "M")
sim_basket <- sample(shot_outcomes, size = NUMBER_OF_SHOTS, replace = TRUE, 
                          prob = c(PROB_MAKE, PROB_MISS))
```

#### Question to Answer

::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
**What part of the code chunk above tells the computer that the events are independent?**
:::
...
## Bring it All Together - Comparing Kobe Bryant to the Independent Shooter
...
::: {style="color: black; background-color: white; padding: 15px; border: 5px solid #006CB3; border-radius: 5px;"}
**Describe the distribution of streak lengths. What is the typical streak length for this simulated independent shooter with a 45% shooting percentage? How long is the player's longest streak of baskets in 133 shots? Make sure to reference elements from the plot you created in your answer.**
:::
...
I edited a lab build by the authors of OpenIntro's Advanced High School Statistics. 

Probability, <http://openintrostat.github.io/oilabs-tidy/03_probability/probability.html.>
